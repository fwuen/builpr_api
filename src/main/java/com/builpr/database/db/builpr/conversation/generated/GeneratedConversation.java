...
public interface GeneratedConversation {
     ...
     */
    IntField<Conversation, Integer> CONVERSATION_ID = IntField.create(
     ...
     */
    IntForeignKeyField<Conversation, Integer, User> USER_ID1 = IntForeignKeyField.create(
        Identifier.USER_ID1,
     ...
     */
    IntForeignKeyField<Conversation, Integer, User> USER_ID2 = IntForeignKeyField.create(
        Identifier.USER_ID2,
     ...
     */
    ComparableField<Conversation, Timestamp, Timestamp> CREATE_DATE = ComparableField.create(
     ...
     */
    ComparableField<Conversation, Timestamp, Timestamp> LAST_MSG_TIME = ComparableField.create(
