 ...
 * com.builpr.database.db.builpr.printable.Printable}-interface.
 * <p>
...
public abstract class GeneratedPrintableImpl implements Printable {
    ...
    @Override
    public Printable setFile(String file) {
        this.file = file;
        return this;
    }
    ...
    public boolean equals(Object that) {
        ...
        if (!Objects.equals(this.getFile(), thatPrintable.getFile())) {return false; }
        if (this.getAgeRestriction() != thatPrintable.getAgeRestriction()) {return false; }
