...
public interface GeneratedPrintable {
     ...
     */
    StringField<Printable, String> FILE = StringField.create(
        Identifier.FILE,
        Printable::getFile,
        Printable::setFile,
        TypeMapper.identity(), 
     ...
     */
    BooleanField<Printable, Integer> AGE_RESTRICTION = BooleanField.create(
     ...
     * @return               this Printable instance
     */
    Printable setAgeRestriction(boolean ageRestriction);
