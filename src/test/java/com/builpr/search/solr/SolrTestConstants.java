...
public class SolrTestConstants {
    ...
    static final String REMOTE_BASE_URL_EXTERN = "http://192.168.1.50:8983/solr";
    ...
    static String p2Description = "This is just a simple gotha bomber from world war 1. print up on its nose with supports for best result. enjoy!";
    static String p3Description = "Its just a thin hookah / shisha...\nNOT smokable... :D";
    static String p4Title = "Trick Fidget Spinner (Three and Two weight models)";
    static String p4Description = "This is a quick model I threw together making a fidget spinner. I thought I'd change things up a bit and make it easier to hold onto and fun to do cool \"tricks\" on almost like a yoyo. Enjoy and do as you wish.\n" +
            "Print Settings\n" +
            "\n" +
            "Printer:\n" +
            "Prusa i3 Mk 2\n" +
    ...
    static String p5Title = "azreiöjypoOIPAÖOIRHQHWEUPRIALDIFGhahueiprqi";
    static String p5Description = "FPWQOIQEROQWIEUöfuqpweiurhqweriaödööfejÖHPIQUHEWJRK:BNLKJDXVOUIHERQLEHR";
}
