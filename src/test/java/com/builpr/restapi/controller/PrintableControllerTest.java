...
import com.builpr.restapi.configuration.SecurityConfiguration;
...
public class PrintableControllerTest extends ControllerTest {
    ...
    @InjectMocks
    private PrintableController printableController;

    @Before
    public void setUpDatabase() throws IOException {
        MockitoAnnotations.initMocks(this);
        mockMvc = MockMvcBuilders.standaloneSetup(printableController).build();
...
////
//        when(printableUploader.uploadFile(VALID_FILE)).thenReturn("test");

//        PrintableUploader aSpy = Mockito.spy(new PrintableUploader());
//        Mockito.doReturn("test").when(aSpy).uploadFile(VALID_FILE);
//
//        Mockito.when(aSpy.uploadFile(printableNewRequest.getFile())).thenReturn("testpath");
